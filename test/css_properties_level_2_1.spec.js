...
assert_group("CSS Level 2.1 ", () => {
    assert_group("box-model: https://www.w3.org/TR/CSS2/box.html", () => {
    ...
    assert_group("Visual Formatting: https://www.w3.org/TR/CSS2/visuren.html", () => {
    ...
    assert_group("Visual Effect: https://www.w3.org/TR/CSS2/visufx.html", sequence, function () {
        ...
        assert(test.value("clip:rect(20vh,31em,auto,58)").check(""));
    ...
    assert_group("User Interface: https://www.w3.org/TR/CSS2/ui.html", sequence, function () {
        ...
        assert(test.value("outline-width: 2px 4px 8px 9px").check([checkLength(2, "px"), checkLength(4, "px"), checkLength(8, "px"), checkLength(9, "px")]));
